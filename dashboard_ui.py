...
class Ui_RobotDashBoard(object):
    def setupUi(self, RobotDashBoard):
        ...
        self.label_ping_gstreamer = QtWidgets.QLabel(self.centralwidget)
        self.label_ping_gstreamer.setObjectName("label_ping_gstreamer")
        self.verticalLayout_2.addWidget(self.label_ping_gstreamer)
        self.plot_ping_gstreamer = Plot(self.centralwidget)
        self.plot_ping_gstreamer.setObjectName("plot_ping_gstreamer")
        self.verticalLayout_2.addWidget(self.plot_ping_gstreamer)
    ...
    def retranslateUi(self, RobotDashBoard):
        ...
        self.label_ping_gstreamer.setText(_translate("RobotDashBoard", "<center><b>Ping[ms]</b></center>"))

...
class Ui_RobotDashBoard(object):
    def setupUi(self, RobotDashBoard):
        ...
        self.plot_fps.setMinimumSize(QtCore.QSize(0, 100))
        self.plot_fps.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.plot_bitrate.setMinimumSize(QtCore.QSize(0, 100))
        self.plot_bitrate.setMaximumSize(QtCore.QSize(16777215, 100))
        self.plot_bitrate.setObjectName("plot_bitrate")
        self.layout_video.addWidget(self.plot_bitrate)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setObjectName("label_2")
        self.layout_video.addWidget(self.label_2)
        self.plot_jitter = Plot(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.plot_jitter.sizePolicy().hasHeightForWidth())
        self.plot_jitter.setSizePolicy(sizePolicy)
        self.plot_jitter.setMinimumSize(QtCore.QSize(0, 100))
        self.plot_jitter.setMaximumSize(QtCore.QSize(16777215, 100))
        self.plot_jitter.setObjectName("plot_jitter")
        self.layout_video.addWidget(self.plot_jitter)
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setObjectName("label_9")
        self.layout_video.addWidget(self.label_9)
        ...
        self.layout_video.addWidget(self.widget)
    ...
    def retranslateUi(self, RobotDashBoard):
        ...
        self.label_8.setText(_translate("RobotDashBoard", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Bitrate [Mps]</span></p></body></html>"))
        self.label_2.setText(_translate("RobotDashBoard", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Jitter [ms]</span></p></body></html>"))
        self.label_9.setText(_translate("RobotDashBoard", "<center><b>Network delay (round-trip) [ms]</b></center>"))
from led import Led

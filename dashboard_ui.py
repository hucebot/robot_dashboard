...
class Ui_RobotDashBoard(object):
    def setupUi(self, RobotDashBoard):
        ...
        self.layout_network.addWidget(self.label_2)
        ...
        self.label_gstreamer_src = QtWidgets.QLabel(self.centralwidget)
        self.label_gstreamer_src.setObjectName("label_gstreamer_src")
        self.layout_video.addWidget(self.label_gstreamer_src)
    ...
    def retranslateUi(self, RobotDashBoard):
        ...
        self.label_gstreamer_src.setText(_translate("RobotDashBoard", "Source:"))

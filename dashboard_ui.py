...
class Ui_RobotDashBoard(object):
    def setupUi(self, RobotDashBoard):
        ...
        self.layout_plots.addWidget(self.label_3)
        self.plot_solver = MplWidget(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.plot_solver.sizePolicy().hasHeightForWidth())
        self.plot_solver.setSizePolicy(sizePolicy)
        self.plot_solver.setObjectName("plot_solver")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.plot_solver)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.layout_plots.addWidget(self.plot_solver)
    ...
    def retranslateUi(self, RobotDashBoard):
        ...
        self.label_3.setText(_translate("RobotDashBoard", "<center><b>Solver time (ms)</b></center>"))
